...
export declare function flags(names: Array<string>, values: Array<number>): Record<string, boolean>;
export declare function unflags(names: Array<string>, flagsObj?: Record<string, boolean | undefined>): Array<number>;
